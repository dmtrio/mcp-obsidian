...
const cliWatchArgs = {};
if (cliPollTimeout !== undefined)
    cliWatchArgs.pollTimeout = cliPollTimeout;
if (cliSessionTimeout !== undefined)
    cliWatchArgs.sessionTimeout = cliSessionTimeout;
    ...
    try {
        switch (name) {
            ...
            case "watch_comments": {
                ...
                const excludeAuthors = trimmedArgs.excludeAuthors || [];
                ...
                for (const changedFile of watchResult.changedFiles) {
                    try {
                        ...
                        const newActionable = commentService.getNewActionableComments(commentFile, notePath, previousSeen, excludeAuthors);
